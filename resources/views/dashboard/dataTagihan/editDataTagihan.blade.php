...
@section('content')
    <div class="p-8">
        <div class="mb-8 anim-fade-up" style="animation-delay: 0.05s;">
            <h1 class="font-display text-3xl font-bold text-white tracking-tight">Halaman Form Tambah Edit Tagihan
            </h1>
        </div>
        ...
        <div class="lg:col-span-2 bg-slate-800 rounded-2xl p-6 animate-fade-up" style="animation-delay:0.4s">
            ...
            <form action="/dashboard/tagihan/edit_data_tagihan/{{ $bills->id }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <select id="rental_id" name="rental_id"
                                        ...
                                        @foreach ($rentals as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('nama', $bills->rental_id) == $item->id ? 'selected' : '' }}>
                                                {{ $item->tenants->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input id="nomor_kamar_display" type="text" readonly
                                            value="{{ old('nomor_kamar', $bills->nomor_kamar) }}"
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input id="bulan" type="number" name="bulan"
                                            value="{{ old('bulan', $bills->bulan) }}" placeholder="masukan bulan"
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input id="tahun" type="number" name="tahun"
                                            value="{{ old('tahun', $bills->tahun) }}" placeholder="masukan tahun"
                                            min="2000" max="2100"
                                            class="block min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" />
                                    </div>
                                </div>
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input id="jatuh_tempo" type="date" name="jatuh_tempo"
                                            value="{{ old('jatuh_tempo', $bills->jatuh_tempo) }}"
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <div
                                        class="flex items-center rounded-md bg-white/5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                                        Rp. <input id="nominal" type="number"
                                            value="{{ old('nominal', $bills->nominal) }}" name="nominal"
                                ...
                                <div class="mt-2 grid grid-cols-1">
                                    <select id="status" name="status"
                                        ...
                                        <option value="belum_bayar"
                                            {{ $bills->status == 'belum_bayar' ? 'selected' : '' }}>
                                            Belum Bayar
                                        </option>
                                        <option value="lunas" {{ $bills->status == 'lunas' ? 'selected' : '' }}>>
                                            Lunas
                                        </option>
                                        <option value="terlambat" {{ $bills->status == 'terlambat' ? 'selected' : '' }}>>
                                            Terlambat
                                        </option>
                                    </select>
                                    <svg viewBox="0 0 16 16" fill="currentColor" data-slot="icon" aria-hidden="true"
